...
function boot() {
  ...
  window.iconEnl = L.Icon.Default.extend({options: { iconUrl: '@@INCLUDEURI:images/marker-green.png@@' } });
  window.iconRes = L.Icon.Default.extend({options: { iconUrl: '@@INCLUDEURI:images/marker-blue.png@@' } });
...
@@INCLUDEURI:external/leaflet.js@@
